        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            @foreach($mots_clefs as $m)
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
{{--                        <button onclick="GetIdMotClef({{$m->id}})" type="submit" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 w-full">--}}
{{--                            data-modal-target="popup-modal" data-modal-toggle="popup-modal">                 --}}
{{--                            Supprimer--}}
{{--                        </button>--}}
                        <form action="{{route('motcle.destroy',[$m->id])}}" method="POST">
                            @csrf @method('DELETE')
                            <button class="text-white bg-red-400 hover:bg-red-500 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:focus:ring-red-900 w-full">
                                Suprimmer
                            </button>
                        </form>
                    </td>
